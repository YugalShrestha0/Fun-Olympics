...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM comment WHERE id = '$deleteId'";
        ...
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="#"
                   style="text-transform:uppercase"><?php echo $_SESSION['email']; ?> <span
            ...
            <table class="table table-dark table-hover table-bordered">
                ...
                while ($row = mysqli_fetch_array($run)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $date; ?></td>
                        <td>
                            <a class="btn btn-danger" href="view-comment.php?delete_id=<?php echo $commentId; ?>"
